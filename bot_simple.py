...
from config import BOT_TOKEN, WEBINARS, PURCHASE_LINK, HALF_WEBINAR_LINK_TEMPLATE
...
@bot.message_handler(func=lambda message: message.text == "Хочу вебинар!")
...
@bot.message_handler(func=lambda message: message.text == "Все еще сомневаюсь")
...
@bot.message_handler(func=lambda message: message.text == "Остались сомнения")
...
@bot.message_handler(func=lambda message: any(webinar in message.text and "половина бесплатно" in message.text for webinar in WEBINARS))
...
@bot.message_handler(func=lambda message: message.text == "Хочу полный доступ")
...
@bot.message_handler(func=lambda message: any(webinar == message.text for webinar in WEBINARS))
